...
PROJECT_REPO ?= github.com/MattGill98/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 3.18.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-vault
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vault_v3.18.0_x5
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/vaults/01-delete.yaml.tmpl.
